...
|                     | select           | color  | `--select`              | `#6EB3E4`  ![#6EB3E4](https://placehold.co/65x20/6EB3E4/6EB3E4) | Color of selection underline                                                                                                                 |
|                     | hover            | color  | `--hover`               | `#78E076`  ![#78E076](https://placehold.co/65x20/78E076/78E076) | Color of hover overline                                                                                                                      |
|                     |                  |        |                         |                                                                 |                                                                                                                                              |
